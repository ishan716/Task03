...
function CommitteeManager() {
  ...
  const loadMembers = async () => {
    try {
      ...
      const response = await fetch('https://event-manager-app-jade.vercel.app/api/organizer/committee', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Use member_id for update operations
      const url = editingMember 
        ? `https://event-manager-app-jade.vercel.app/api/organizer/committee/${editingMember.member_id}`
        : 'https://event-manager-app-jade.vercel.app/api/organizer/committee';
  ...
  const handleDelete = async (member_id) => {
    ...
    try {
      ...
      // Updated URL to use member_id
      const response = await fetch(`https://event-manager-app-jade.vercel.app/api/organizer/committee/${member_id}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
