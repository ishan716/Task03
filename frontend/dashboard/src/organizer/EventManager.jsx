...
function EventManager() {
  ...
  const loadCategories = async () => {
    try {
      ...
      const response = await fetch('https://event-manager-app-jade.vercel.app/api/organizer/categories', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = editingEvent 
        ? `https://event-manager-app-jade.vercel.app/api/organizer/events/${editingEvent.event_id}`
        : 'https://event-manager-app-jade.vercel.app/api/organizer/events';
  ...
  const handleDelete = async (eventId) => {
    ...
    try {
      ...
      const response = await fetch(`https://event-manager-app-jade.vercel.app/api/organizer/events/${eventId}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
